...
#-----실습2-20
# 거래내역에서 입금 건수, 출금 건수, 조회 건수를 조회하시오.
SELECT
...
#-----실습2-21
# 거래 내역에서 거래 구분번호를 통해 type을 아래와 같이 조회하시오.
SELECT 
		`t_dist`,
			case
...
#-----실습2-24
# 입금 거래만 계좌별로 합계 구하고 10만원 이상만 큰 순서로 조회하시오.
...
#-----실습2-29
# 거래 구분이 입금이고 큰 거래금액 순으로 아래와 같이 데이터가 조회되도록 하시오.
SELECT
		`t_no`,
		`a_no`,
		`c_no`,
...
#-----실습2-30
# 거래구분이 입금, 출금이고 개인 고객을 대상으로 거래건수를 아래와 같이 조회하시오.
